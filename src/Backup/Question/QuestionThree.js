...
const QuestionsThree = props => {
  ...
  const quizData = [
    {
      quiz_id: '20',
      title: 'The average of first 50 natural numbers is …………. ',
      correct_answer: '25.5',
    },
    {
      quiz_id: '21',
      title: 'A fraction which bears the same ratio to 1/27 as 3/11 bear to 5/9 is equal to ……….. .',
      correct_answer: '55',
    },
    {
      quiz_id: '25',
      title: '. Evaluation of 83 × 82 × 8-5 is …………. .',
      correct_answer: 'None of these',
    },
    {
      quiz_id: '26',
      title: 'Name a triangle whose two angles are equal.',
      correct_answer: 'None of these',
    },
  ];
  ...
  const submitQuiz = async () => {
    ...
    try {
      ...
      if (response.data.status === '200') {
        ...
        props.navigation.navigate('ReportCardAdvanced');
        console.log('data',formData);
      } else {
