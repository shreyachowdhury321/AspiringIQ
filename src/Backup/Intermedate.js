...
const QuestionsTwo = props => {
  ...
  const quizData = [
    {
      quiz_id: '11',
      title: 'What do you call the process by which plants make their own food?',
      correct_answer: '4',
    },
    {
      quiz_id: '16',
      title: 'Find out more about Mrs Nerg and the seven life processes',
      correct_answer: 'Sensitivity',
    },
    {
      quiz_id: '27',
      title: 'Protein in the pulses (or more correctly legume) is found in which of the following form?',
      correct_answer: 'Albumin',
    },
    {
      quiz_id: '28',
      title: 'Which of the following vertebrae are found in Neck ?',
      correct_answer: 'Cervical',
    },
    {
      quiz_id: '29',
      title: 'Which of the following is done by an Antigen?',
      correct_answer: 'triggers the immune system',
    },  
    {
      quiz_id: '30',
      title: 'How many vocal cords are there in the human voice box?',
      correct_answer: 'Two',
    }, 
  ...
  const submitQuiz = async () => {
    ...
    try {
      ...
      if (response.data.status === '200') {
        ...
        props.navigation.navigate('ReportCardIntermedeate');
        console.log('data',formData);
      } else {
